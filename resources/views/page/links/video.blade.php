...
<div x-data="{open: false}">
    ...
    >
        <iframe id="media-{{ $id }}" src="{{ $embedUrl }}" title="{{ $data['title'] }}" frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
</div>
